...
export const newsData = [
  ...
  {
    id: 2,
    title: 'Vaibhav Publishes Comprehensive Review on Xenobiotic Detoxification by Cytochrome P450s',
    date: '27 July, 2026',
    category: 'Publications',
    featured: true,
    summary: 'Congratulations to Vaibhav on publishing a comprehensive review article elucidating xenobiotic detoxification mechanisms by Cytochrome P450s.',
    content: 'Congratulations to Vaibhav on the publication of his review article focusing on Xenobiotic Detoxification by Cytochrome P450s! The review provides an in-depth perspective on enzymatic mechanisms, molecular dynamics of detoxification pathways, and their computational modeling applications. Excellent effort and congratulations to Vaibhav!',
    tags: ['Review Article', 'Xenobiotic Detoxification', 'Cytochrome P450', 'Publication'],
    link: '/publications',
    author: 'Computational Biocatalysis Lab'
  },
  {
