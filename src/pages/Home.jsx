                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-10 lg:gap-14">
                        ...
                        <div className="w-full lg:w-3/5 space-y-5 text-left flex flex-col justify-center">
                            ...
                            <div className="space-y-4 text-slate-200 text-sm md:text-base leading-relaxed">
                                <p>
                                    Our laboratory investigates the molecular principles that govern protein structure, dynamics, electrostatics, and enzymatic catalysis, with a primary focus on the Cytochrome P450 superfamily and other biologically important enzymes. We combine computational structural biology, molecular simulations, quantum chemistry, and multiscale modelling to understand biological systems from the atomic to the electronic level.
                                </p>
                                <p>
                                    A central theme of our research is to understand how the structure and dynamic behaviour of enzymes control chemical reactivity and biological function. Cytochrome P450s, with their remarkable versatility in substrate recognition, oxygen activation, and selective C–H functionalization, provide a major platform for investigating these fundamental questions. We investigate protein–ligand and protein–nucleic acid interactions, conformational dynamics, active-site architecture, mutation-induced functional changes, and long-range communication within biomolecules. Through the analysis of molecular and electric fields, we further examine how the protein environment modulates molecular properties, organizes active sites, and guides chemical reactions.
                                </p>
                                <p>
                                    We investigate enzymatic reactions at the level of molecular and electronic structure, using hybrid QM/MM and quantum-chemical approaches to characterize reaction pathways, reactive intermediates, transition states, proton and electron transfer, hydrogen-atom transfer, spin-state changes, and complex metal–oxygen and redox chemistry. Particular emphasis is placed on understanding how protein dynamics, solvent, electrostatics, and active-site architecture collectively shape reaction mechanisms in Cytochrome P450s and other metalloenzymes.
                                </p>
                                <p>
                                    Beyond understanding naturally occurring enzymes, our research seeks to translate mechanistic insight into rational enzyme design and engineering. We explore active-site redesign, substrate specificity, enzyme stability, catalytic efficiency, and the principles required to create or modify catalytic function.
                                </p>
                                <p>
                                    By integrating structure, dynamics, electrostatics, and electronic structure, our laboratory seeks to move beyond describing biological systems toward predicting and ultimately controlling molecular function. Our overarching goal is to establish a fundamental understanding of enzymatic chemistry—particularly the remarkable catalytic strategies of Cytochrome P450s—and to use these principles to guide the rational design and engineering of new and improved biological catalysts.
                                </p>
                            </div>
                        </div>
